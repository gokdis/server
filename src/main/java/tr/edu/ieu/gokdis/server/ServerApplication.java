...
public class ServerApplication {
    ...
    public CommandLineRunner savePeople(PersonRepository personRepository) {
        return args -> {
            ...
            personRepository.save(new Person(UUID.randomUUID(), "helen", "admin", "helen@ieu.edu.tr",
                    "80c95d0e9e710a56937209d81da3043b5dfed8174bb6acc01e334ecaa6408a97", 17));
            personRepository.save(new Person(UUID.randomUUID(), "user", "paris", "paris@ieu.edu.tr",
